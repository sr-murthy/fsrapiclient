...
from fsrapiclient.__version__ import __version__
...
github_repo = f'{github_url}/sr-murty/fsrapiclient'
github_version = 'main'
pypi_project = 'https://pypi.org/project/fsrapiclient/'
project = fsrapiclient.__name__
release = __version__
...
.. |github_release_target|  replace:: https://github.com/sr-murthy/fsrapiclient/releases/tag/{release}
.. |pypi_release_target|    replace:: https://pypi.org/project/fsrapiclient/{release}
"""
...
modindex_common_prefix = ["fsrapiclient."]

doctest_global_setup = "import fsrapiclient"
...
html_context = {
    ...
    'release': release,
    'release_target': f'https://github.com/sr-murthy/fsrapiclient/releases/tag/{release}'
}
...
#    #"sources/fsrapiclient/*": ["sidebar-nav-bs"],
#}
...
html_theme_options = {
    ...
    #'icon_links': [
    #    {
    #        'name': 'fsrapiclient@GitHub',
    #        'url': f'https://github.com/sr-murthy/fsrapiclient',
...
htmlhelp_basename = 'fsrapiclient'
